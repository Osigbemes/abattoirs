"""
URL configuration for proteintech project.
...
urlpatterns = [
    ...
    path('abattoir/', include('apps.abattoirs.urls'), name='abattoirs'),
    path('certificate/', include('apps.certificates.urls'), name='certificates'),
